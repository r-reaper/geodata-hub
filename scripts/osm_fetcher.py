...
def fetch_layer(layer_slug: str) -> bool:
    ...
    is_admin = layer_slug in ADMIN_LAYERS
...
if __name__ == "__main__":
    ...
    parser.add_argument("--layer", choices=["roads", "waterways", "buildings", "province", "amphoe", "tambon", "all"], required=True)
    parser.add_argument("--ensure-schema", action="store_true", help="No-op for file-based mode")
    args = parser.parse_args()

    if args.layer == "all":
        for layer in ["roads", "waterways", "buildings", "province", "amphoe", "tambon"]:
