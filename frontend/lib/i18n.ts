...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "feedback.subtitle":           "Help shape Thai GeoData Hub. Suggest a layer, share data, or report a bug.",
    "feedback.kind.feedback":      "💬 General",
    "feedback.kind.layer":         "🗺️ Request a layer",
    "feedback.kind.data":          "📤 Share your data",
    "feedback.kind.bug":           "🐛 Bug",
    "feedback.emailLabel":         "Your email (optional, so I can reply)",
    "feedback.msgLabel":           "Message",
    "feedback.placeholder.feedback":"What would make this site more useful for you?",
    "feedback.placeholder.layer":  "Which layer would you like? e.g. 'School locations in Chiang Mai' or 'Hospitals nationwide'.",
    "feedback.placeholder.data":   "Tell me about the dataset you'd like to share — source, license, format, size.",
    "feedback.placeholder.bug":    "What went wrong? Steps to reproduce, browser/device.",
    "feedback.send":               "Send via email",
    "feedback.privacy":            "Opens your email app — no data is sent to a server.",

    "err.api.title":          "Can't reach the backend",
  ...
  th: {
    ...
    "feedback.subtitle":           "ช่วยพัฒนา Thai GeoData Hub แนะนำชั้นข้อมูล แชร์ข้อมูล หรือแจ้งบั๊ก",
    "feedback.kind.feedback":      "💬 ทั่วไป",
    "feedback.kind.layer":         "🗺️ ขอชั้นข้อมูลใหม่",
    "feedback.kind.data":          "📤 แชร์ข้อมูลของคุณ",
    "feedback.kind.bug":           "🐛 แจ้งบั๊ก",
    "feedback.emailLabel":         "อีเมลของคุณ (ไม่บังคับ เผื่อจะตอบกลับได้)",
    "feedback.msgLabel":           "ข้อความ",
    "feedback.placeholder.feedback":"อยากให้เว็บนี้ดีขึ้นยังไงบ้าง?",
    "feedback.placeholder.layer":  "อยากได้ชั้นข้อมูลอะไร เช่น 'ที่ตั้งโรงเรียนในเชียงใหม่' หรือ 'โรงพยาบาลทั่วประเทศ'",
    "feedback.placeholder.data":   "เล่าเกี่ยวกับชุดข้อมูลที่อยากแชร์ — แหล่งที่มา สัญญาอนุญาต รูปแบบไฟล์ ขนาด",
    "feedback.placeholder.bug":    "เกิดอะไรขึ้น? วิธีทำซ้ำ เบราว์เซอร์/อุปกรณ์",
    "feedback.send":               "ส่งทางอีเมล",
    "feedback.privacy":            "เปิดแอปอีเมลของคุณ — ไม่มีการส่งข้อมูลไปยังเซิร์ฟเวอร์",

    "err.api.title":          "เชื่อมต่อ backend ไม่ได้",
