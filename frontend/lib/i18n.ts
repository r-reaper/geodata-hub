...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "step4.footer":           "100% free · Donations welcome 💝 · No login required",
    ...
    "donate.subtitle":        "All downloads are free. If this tool saved you time, a small donation keeps the servers running.",
    "donate.bmac":            "☕ Buy Me a Coffee",
    "donate.promptpay":       "🇹🇭 PromptPay (Thai donors)",
    "donate.promptpayHint":   "Open your bank app → PromptPay → enter the email above as recipient.",
    "donate.footer":          "Any amount welcome 🙏  ·  Made with ❤️ in Thailand for the GIS community.",
    ...
    "intro.s4.d":             "100% free — SHP, GeoJSON, KML included with proper attribution files. Donations welcome 💝",
  ...
  th: {
    ...
    "step4.footer":           "ฟรี 100% · รับบริจาค 💝 · ไม่ต้องล็อกอิน",
    ...
    "donate.subtitle":        "ดาวน์โหลดทั้งหมดฟรี ถ้าเครื่องมือนี้มีประโยชน์ ขอบริจาคเล็กน้อยเพื่อคงเซิร์ฟเวอร์ไว้ครับ",
    "donate.bmac":            "☕ Buy Me a Coffee",
    "donate.promptpay":       "🇹🇭 พร้อมเพย์ (สำหรับผู้บริจาคชาวไทย)",
    "donate.promptpayHint":   "เปิดแอปธนาคาร → พร้อมเพย์ → กรอกอีเมลด้านบนเป็นปลายทาง",
    "donate.footer":          "ยินดีรับทุกจำนวน 🙏  ·  สร้างด้วย ❤️ ในประเทศไทย เพื่อชุมชน GIS",
    ...
    "intro.s4.d":             "ฟรี 100% — มี SHP, GeoJSON, KML พร้อมไฟล์ระบุที่มา รับบริจาคได้ 💝",
